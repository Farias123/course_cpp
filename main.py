...
def choose_data_file():
    ...
    completely under or out of the water), whereas the numerical method is an approximation of the solution that works
    for more complex cases but diverges if the interval dt is not small enough.""")
    while True:
